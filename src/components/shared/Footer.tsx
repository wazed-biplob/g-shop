  ...
  return (
    <>
      <footer className="p-6 dark:bg-gray-100 dark:text-gray-800">
        ...
        <div className="flex flex-col items-center justify-center px-6 pt-12 text-sm gap-y-2">
          <hr className="bg-slate-400 w-full h-[0.5px] inline" />
          <span className="dark:text-gray-600">
            © Copyright Ocean&apos;s Bounty 2024. All Rights Reserved.
          </span>
        </div>
      </footer>
    </>
