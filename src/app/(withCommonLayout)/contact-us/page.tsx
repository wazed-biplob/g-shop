            ...
            <div className="mx-2 pt-12 text-center md:mx-auto md:w-2/3 md:pb-12">
              <div className="text-lg sm:text-xl xl:text-xl">
                <div className="text-gray-900">
                  <p className="mb-4">
                    Whether you have questions, feedback, or simply want to say
                    hello, we&apos;re here to assist you. Our dedicated team at
                    Ocean&apos;s Bounty is committed to providing exceptional
                    customer service and ensuring your shopping experience is
        ...
        <div className="mx-auto mb-20 flex w-full max-w-screen-lg flex-col overflow-hidden rounded-xl text-gray-900 md:flex-row md:border md:shadow-lg">
          <form className="mx-auto w-full max-w-xl border-gray-200 px-10 py-8 md:px-8">
            ...
            <div className="flex items-center">
              ...
              <button
                className="rounded-xl bg-slate-400 px-4 py-3 text-center font-bold text-white hover:bg-slate-600"
                type="submit"
              >
                Send message
              </button>
          ...
          <div className="mt-10 bg-slate-500 px-10 py-8 text-gray-100 md:mt-0 md:ml-auto">
            <div className="">
